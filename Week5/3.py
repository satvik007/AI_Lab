...
class Environment:
    ...
    def astar(self):
        ...
        q.put(((self.h(self.arr), 0, _hash), (copy.deepcopy(self.arr), self.zero)))
        ...
        while not q.empty():
            ...
            for i in range(0, 4):
                ...
                if i == 0:
                    ...
                    if ret and _hash not in dist or dist[_hash] > depth:
                        parent[_hash] = state, i
                        dist[_hash] = depth
                        q.put(((self.h(new_state) + depth + 1, depth + 1, _hash), (new_state, new_zero)))
